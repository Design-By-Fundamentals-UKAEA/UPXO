...
# -------------------------------------------------
# Example / self-test: writes a minimal job1.inp demonstrating write_elset
# and write_grain_elsets. Only runs when this file is executed directly,
# not on import (an earlier version ran this unconditionally at import
# time, writing job1.inp to the caller's CWD as an import side effect).
# -------------------------------------------------
