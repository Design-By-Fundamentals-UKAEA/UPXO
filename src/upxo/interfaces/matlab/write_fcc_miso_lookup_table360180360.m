...
folder = 'C:\Development\M2MatMod\upxo_packaged\upxo_private\src\upxo\_written_data\_orientation';
writetable(MIS_table, strcat(folder, filesep, 'fcc_std_miso_360_180_360.txt'), 'Delimiter',' ')
writetable(MIS_table, strcat(folder, filesep, 'fcc_std_miso_360_180_360.csv'), 'Delimiter',' ')
