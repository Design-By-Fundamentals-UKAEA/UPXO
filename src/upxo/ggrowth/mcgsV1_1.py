"""mcgsV1_1 -- a lean, interactively-driven Monte-Carlo grain-growth entry point for
...
pipeline's Monte-Carlo stage.

Why a new module instead of wiring this straight to mcgs.mcgs
------------------------------------------------------------------
...
dict and simply discarded even inside mcgs.py itself. Wiring this module to
...
class MCGSConfig:
    ...
    from external shared_state, no Excel dashboard involved.
...
class mcgsV1_1:
    ...
    can be swapped in for external wiring without reshaping the rest of the
