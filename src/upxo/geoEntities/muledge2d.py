...
class muledge2d():
    ...
    Notes
    -----
    Several mutation methods rebuild the internal point, edge, memory-id, and
    multi-point databases after editing the chain. These cached structures are
    part of the public state used by older UPXO geometry workflows.
    """
    ...
    def __repr__(self):
        """
        Return a compact multi-edge summary string.

        Returns
        -------
        str
            Summary containing object id, edge count, point count, closure
            state, edge/point sense, and ordering state.
        """
        string = []
    ...
    def __len__(self):
        ...
        -------
        int
            Number of constituent ``edge2d`` objects.
        """
    ...
    def dbbuild_pmid_pairs(self):
        ...
        -------
        None
            Updates ``self.pmid_pairs`` in place.
        """
    ...
    def dbbuild_points(self,
                       ...
                       data=None):
        """
        Rebuild ``self.points`` from point-pair data.

        Parameters
        ----------
        method : str, optional
            Rebuild strategy. Currently ``'ppairs'`` rebuilds the ordered point
            deque from ``self.ppairs``.
        data : object, optional
            Reserved for alternate rebuild inputs.
    ...
    def dbbuild_empoint(self):
        ...
        -------
        None
            Updates ``self.empoints`` in place.
        """
        self.empoints = [mulpoint2d(method='up2d_list',
                                    point_objects=pp,
    ...
    def centroid(self):
        ...
        -------
        Point2d
            Centroid of the underlying multi-point object.
        """
    ...
    def centroids(self):
        """
        Return centroids of constituent edges.

        Returns
        -------
        list
            Centroid point of each ``edge2d`` in the chain.
        """
    ...
    def lengths(self):
        """
        Return lengths of constituent edges.

        Returns
        -------
        list of float
            Length of each ``edge2d`` in the chain.
        """
    ...
    def slopes(self):
        """
        Return slopes of constituent edges.

        Returns
        -------
        list of float
            Slope of each ``edge2d`` in the chain.
        """
    ...
    def length(self):
        """
        Return total length of constituent edges.

        Returns
        -------
        float
            Sum of all edge lengths in the chain.
        """
    ...
    def mean_length(self):
        """
        Return mean length of constituent edges.

        Returns
        -------
        float
            Arithmetic mean of all edge lengths in the chain.
        """
    ...
    def mean_slope(self):
        """
        Return mean slope of constituent edges.

        Returns
        -------
        float
            Arithmetic mean of all edge slopes in the chain.
        """
    ...
    def roughness(self):
        """
        Roughness measure of the chain.

        Raises
        ------
        NotImplementedError
            Always raised because the roughness measure is not implemented.
        """
    ...
    def insert_coord_at(self, coord, indices=[0, 1]):
        """
        Insert a raw coordinate into the chain at the given edge indices.

        Parameters
        ----------
        coord : array-like
            Coordinate to insert into the multi-edge chain.
        indices : list of int, optional
            Edge or point indices that identify the insertion location.
            Default is ``[0, 1]``.

        Raises
        ------
        NotImplementedError
            Always raised because coordinate insertion is not implemented.
        """
        # Update clist and Update cpairs
        # Update points
        # Update pindices
    ...
    def insert_point_bw(self, k=0.5):
        """
        Insert a point at fractional position ``k`` along each edge.

        Parameters
        ----------
        k : float, optional
            Fractional position along the edge, where ``0`` corresponds to
            the start point and ``1`` to the end point. Default is ``0.5``.

        Raises
        ------
        NotImplementedError
            Always raised because fractional insertion is not implemented.
        """
        # Make coord
        # Make point object
        # Update points
    ...
    def move_pointat(self, coord=[0, 0]):
        """
        Move the point at ``coord`` to a new position.

        Parameters
        ----------
        coord : array-like, optional
            Coordinate of the point to be moved. Default is ``[0, 0]``.

        Raises
        ------
        NotImplementedError
            Always raised because coordinate-based point movement is not
            implemented.
        """
        # Update points
        # Update pindices
    ...
    def explode(self, k, method='centroid'):
        """
        Explode the chain outward from a reference location.

        Parameters
        ----------
        k : float
            Scaling factor for outward movement.
        method : str, optional
            Reference definition for the explosion operation. Default is
            ``'centroid'``.

        Raises
        ------
        NotImplementedError
            Always raised because chain explosion is not implemented.
        """
    ...
    def move(self):
        """
        Translate the entire multi-edge chain.

        Raises
        ------
        NotImplementedError
            Always raised because whole-chain translation is not implemented.
        """
    ...
    def stretch(self):
        """
        Stretch the chain along an axis.

        Raises
        ------
        NotImplementedError
            Always raised because whole-chain stretching is not implemented.
        """
    ...
    def plotmp(self):
        """
        Plot all multi-point nodes with coordinate annotations.

        Returns
        -------
        None
            Adds point markers and coordinate labels to the active
            Matplotlib axes.
        """
