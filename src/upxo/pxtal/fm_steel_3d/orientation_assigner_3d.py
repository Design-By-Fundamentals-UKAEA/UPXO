...
class OrientationAssigner3D:
    ...
    def __init__(self, verbosity: int = 0, log_sink=None):
        ...
        log_sink : callable, optional
            ...
            routed through it instead of bare print() -- lets a caller
            ...
            is invisible from inside an embedded console (they'd only show up in
            whatever terminal launched the process, not the app itself).
        """
