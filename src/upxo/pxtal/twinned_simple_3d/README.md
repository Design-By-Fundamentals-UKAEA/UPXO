...
- **Windows:** double-click `guiLaunchers/Launch_Twinned_FCC_GUI.bat` (repo root)  
- **Python:** `from upxo.pxtal.twinned_simple_3d.gui_launcher import launch_gui; launch_gui()`
