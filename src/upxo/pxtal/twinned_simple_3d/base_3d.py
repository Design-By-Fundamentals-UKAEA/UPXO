...
class TwinnedSimple3DBase:
    ...
    def calibrate_scale_factor(
        ...
        Method (see the twinned_simple_3d design discussion this
        implements):
        ...
        Caveats callers/UI should surface to the user (see the design
    ...
    def calculate_lfi(
        ...
        previously only guaranteed by interactive click ordering.
    ...
    def clean_temporal_slices(
        ...
        ``min_grain_size`` changed since the first pass. The caller
