    ...
    * ``'tgs.sgs'`` — target and sample grain structures directly
    ...
    def build_merged_ebsd_lfi(self, parent_info: dict, plot: bool = True) -> None:
        ...
        plot : bool
            ...
            comparison figure. Default ``True``; the interactive compute step
    ...
    def compute_mdf_ebsd(self, n_bins=65, angle_range=(0.0, 65.0),
        ...
        plot : bool
            ...
            parameters (e.g. an interactive caller) should pass ``plot=False``
    ...
    def compute_ebsd_texture_stages(
        ...
        admin/twinnedFccApp/texIntegration/scoping.md §6.1 in the UPXO
    ...
    def compute_mc_twin_thickness(
        ...
        # quantiles above. Stored now so any caller (interactive or otherwise) can
