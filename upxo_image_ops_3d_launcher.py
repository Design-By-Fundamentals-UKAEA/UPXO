...
try:
    ...
    messagebox.showerror(
        "Dependency Error",
        "Pillow (PIL) library is required to run the UPXO APP.\n"
...
class ImageOpsApp(customtkinter.CTk if use_customtkinter else tk.Tk):
    def __init__(self, use_customtkinter=False):
        ...
        from upxo.app.GSImageOperations3D.pages import OpsWelcomePage
    ...
    def next_page(self):
        ...
        from upxo.app.GSImageOperations3D.pages import (
